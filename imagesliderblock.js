(function ($) {
  $.fn.imagesliderblock = function (options) {
    var options = $.extend(
      {
    ...
    return this.each(function () {
      ...
      container.wrap(
        "<div class='rebeccagrace-wrapper rebeccagrace-" +
          sliderOrientation +
          "'></div>"
      );
      if (!options.no_overlay) {
        ...
        overlay.append(
          "<div class='rebeccagrace-before-label' data-content='" +
            options.before_label +
            "'></div>"
        );
        overlay.append(
          "<div class='rebeccagrace-after-label' data-content='" +
            options.after_label +
            "'></div>"
        );
      }
      ...
      slider.append(
        "<span class='rebeccagrace-" + beforeDirection + "-arrow'></span>"
      );
      slider.append(
        "<span class='rebeccagrace-" + afterDirection + "-arrow'></span>"
      );
      ...
      $(window).on("resize.imagesliderblock", function (e) {
      ...
      $(window).trigger("resize.imagesliderblock");
    });
  };
})(jQuery);
